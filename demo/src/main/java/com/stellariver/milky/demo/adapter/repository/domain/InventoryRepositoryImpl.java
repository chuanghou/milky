...
public class InventoryRepositoryImpl extends InventoryRepository {
    ...
    public Map<Long, Inventory> queryMapByIdsFilterEmptyIdsAfterCache(Set<Long> itemIds) {
        ...
        return Collect.toMap(inventoryDOs, InventoryDO::getInventoryId,
                inventoryDO -> Inventory.builder().itemId(inventoryDO.getInventoryId()).amount(inventoryDO.getAmount()).build());
    }
}
